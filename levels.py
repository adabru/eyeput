...
Levels = {
    ...
    "keyboard2": {
        ...
        # row 1
        "amp": KeyAction("&", 0, 1, "shift+&"),
        "perc": KeyAction("%", 1, 1, "shift+%"),
        "exclamation": KeyAction("!", 2, 1, "shift+!"),
        "doublequote": KeyAction('"', 3, 1, 'shift+"'),
        "singlequote": KeyAction("'", 4, 1, "shift+'"),
        "backtick": KeyAction("`", 5, 1),
        "dollar": KeyAction("$", 6, 1, "shift+$"),
